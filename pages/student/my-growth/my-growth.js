...
Page({
  ...
  data: {
    desc:[{
      content:"这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！这里是目标的描述！",
    }],
    //stepText:5,
  ...
  onTapToSkill:function() {
    wx.navigateTo({
      url: 'skill/skill',
    })
  },
  onTapToHonor:function() {
    wx.navigateTo({
      url: 'honor/honor',
    })
  },
  
  onTapToEvaluation:function() {
    wx.navigateTo({
